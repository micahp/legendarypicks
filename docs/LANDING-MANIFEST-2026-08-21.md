...
| UFC finish settlement | `39de106` | First make the bounded UFC ingest plan against a clone of the intended target. Apply logs/identities only with a verified backup and explicit DB authorization; then settle a bounded exact game. |
