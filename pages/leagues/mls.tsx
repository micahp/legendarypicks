...
const MLS_TABS = new Set(['scores', 'standings', 'leaders', 'news'])
...
export default function MlsSoccerPage() {
  ...
  return <SoccerLeaguePage initialCompetition="mls" initialSection={tab as 'scores' | 'standings' | 'leaders' | 'news'} />
}
