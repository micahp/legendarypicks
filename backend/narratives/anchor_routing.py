"""Anchor routing — which conversation a story belongs to.
...
from .topic_words import _significant, _topic_hits, _topic_words
...
def _better_home(con, conv, headline, own_entities=(), _cache={}):
    ...
    bridge = {e for e in own_entities if not (_significant(e) & own_words)}
